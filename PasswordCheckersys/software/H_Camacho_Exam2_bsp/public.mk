...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../niosSys.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1900
SOPC_SYSID_FLAG += --sidp=0x1900
ELF_PATCH_FLAG  += --sidp 0x1900

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1585712267
SOPC_SYSID_FLAG += --timestamp=1585712267
ELF_PATCH_FLAG  += --timestamp 1585712267
